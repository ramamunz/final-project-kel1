...
import theMenu from "../assets/the menu 1.png";
import wednesday from "../assets/wednesday.png";
import blackAdam from "../assets/black adam 1.png";
import violentNight from "../assets/violent night 1.png";
import sheHulk from "../assets/she hulk 1.png";
import tar from "../assets/tar 1.png";
import sprited from "../assets/spirited 1.png";
import womanKing from "../assets/the woman king 1.png";
import terrifier from "../assets/terrifier 1.png";
        ...
        <div className="footer-container border-t-2 border-white flex justify-center items-center flex-col py-8 bg-merah-hati text-white">
          <p>
            ...
            <span className="font-extralight">
              <a href="">Blog</a><span className="font-normal mx-1">-</span>
              <a href="">Contact</a>
              <span className="font-normal mx-1">-</span><a href="">Browse Movies</a>
              <span className="font-normal mx-1">-</span><a href="">Request</a>
              <span className="font-normal mx-1">-</span><a href="">Login</a>
              <span className="font-normal mx-1">-</span><a href="">Language</a>
            </span>
          </p>
