...
import banner from "../../assets/img/detailFilm/banner/Escape Plan.jpg";
import { FaRegHeart } from "react-icons/fa6";
import { Link } from "react-router-dom";

function DetailEscapePlan({ favoritFilm, setFavoritFilm }) {
  const dataFilm = {
    id: 3,
    title: "Escape Plan",
    poster: banner,
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row flex-wrap justify-between font-bold text-lg mb-16">
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/etWeYkQ_KLw"
            ></iframe>
          </div>
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.bilibili.tv/id/video/2046827691?bstar_from=bstar-web.homepage.recommend.all"
              allowFullScreen
            ></iframe>
          </div>
        </div>
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row justify-between mb-16">
          <div className="basis-2/5">
            ...
            <p className="text-base font-normal text-justify">
              Escape Plan adalah sebuah film di mana sebuah kotak susu bisa
              menyelamatkan manusia keluar dari penjara laga seru penjara
              Amerika Serikat tahun 2013 yang menampilkan Sylvester Stallone,
              Arnold Schwarzenegger, Jim Caviezel, 50 Cent, Vinnie Jones,
              Vincent D'Onofrio dan Amy Ryan. Film tersebut disutradarai oleh
              pembuat film Swedia Mikael Håfström, dan ditulis oleh Miles
              Chapman dan Jason Keller (di bawah nama pena anagram 'Arnell
              Jesko').
            </p>
...
export default DetailEscapePlan;
