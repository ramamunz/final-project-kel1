...
import banner from "../../assets/img/detailFilm/banner/Scary Movie 4.jpg";
import { FaRegHeart } from "react-icons/fa6";
import { Link } from "react-router-dom";

function DetailScaryMovie4({ favoritFilm, setFavoritFilm }) {
  const dataFilm = {
    id: 4,
    title: "Scary Movie 4",
    poster: banner,
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row flex-wrap justify-between font-bold text-lg mb-16">
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/-Bwr6LB5Dqw"
            ></iframe>
          </div>
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.bilibili.tv/id/video/2006343919"
              allowFullScreen
            ></iframe>
          </div>
        </div>
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row justify-between mb-16">
          <div className="basis-2/5">
            ...
            <p className="text-base font-normal text-justify">
              Scary Movie 4 merupakan sebuah film horor komedi parodi Amerika
              Serikat yang dirilis pada tahun 2006, film ini merupakan film
              keempat dari serial film Scary Movie. Film yang disutradarai oleh
              David Zucker ini pemainnya antara lain oleh Anna Faris, Regina
              Hall, Craig Bierko, dan masih banyak lagi. Tanggal rilisnya pada
              14 April 2006. sekuel film ini Scary Movie 5 dirilis pada tahun
              2013.
            </p>
...
export default DetailScaryMovie4;
