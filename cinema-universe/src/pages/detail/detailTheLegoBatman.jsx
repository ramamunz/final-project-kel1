...
import banner from "../../assets/img/detailFilm/banner/The Lego Batman.jpg";
import { FaRegHeart } from "react-icons/fa6";
import { Link } from "react-router-dom";

function DetailTheLegoBatman({ favoritFilm, setFavoritFilm }) {
  const dataFilm = {
    id: 8,
    title: "Scary Movie 5",
    poster: banner,
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row flex-wrap justify-between font-bold text-lg mb-16">
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/h6DOpfJzmo0"
            ></iframe>
          </div>
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.bilibili.tv/id/video/4786515784896000"
              allowFullScreen
            ></iframe>
          </div>
        </div>
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row justify-between mb-16">
          <div className="basis-2/5">
            ...
            <p className="text-base font-normal text-justify">
              The Lego Batman Movie adalah sebuah film komedi pahlawan super
              animasi komputer 3D tahun 2017 yang disutradarai oleh Chris McKay,
              ditulis oleh Seth Grahame-Smith, Chris McKenna, Erik Sommers,
              Jared Stern dan John Whittington, serta Phil Lord dan Christopher
              Miller, penulis dan sutradara The Lego Movie, bertindak sebagai
              produsernya. Film ini adalah sempalan dari film The Lego Movie,
              dengan cerita yang berfokus pada karakter DC Comics yakni Batman,
              saat ia mencoba untuk mengatasi ketakutan terbesar untuk
              menghentikan rencana terbaru Joker. Film ini dibintangi oleh Will
              Arnett, Zach Galifianakis, Michael Cera, Rosario Dawson dan Ralph
              Fiennes. Film ini merupakan film ketiga yang diproduksi oleh
              Warner Animation Group dan film kedua yang diangkat berdasarkan
              pada properti-properti Lego.
            </p>
            <br />
            <p className="text-base font-normal text-justify">
              The Lego Batman Movie diputar perdana di Dublin, Irlandia pada 29
              Januari 2017 dan dirilis di Amerika Serikat pada 10 Februari 2017.
              Secara internasional, film ini dirilis dalam format 3D, RealD 3D,
              Dolby Cinema, dan IMAX 3D. Film ini menerima ulasan positif dan
              telah mendapat pendapatan $312 juta di seluruh dunia.
            </p>
...
export default DetailTheLegoBatman;
