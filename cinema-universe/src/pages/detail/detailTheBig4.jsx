...
import banner from "../../assets/img/detailFilm/banner/The Big 4.jpg";
import { FaRegHeart } from "react-icons/fa6";
import { Link } from "react-router-dom";

function DetailTheBig4({ favoritFilm, setFavoritFilm }) {
  const dataFilm = {
    id: 19,
    title: "The Big 4",
    poster: banner,
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row flex-wrap justify-between font-bold text-lg mb-16">
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.bilibili.tv/id/video/2048245207"
              allowFullScreen
            ></iframe>
          </div>
        </div>
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row justify-between mb-16">
          <div className="basis-2/5">
            ...
            <p className="text-base font-normal text-justify">
              The Big 4 adalah sebuah film laga komedi Indonesia tahun 2022 yang
              disutradarai oleh Timo Tjahjanto. Film ini dibintangi oleh Abimana
              Aryasatya, Putri Marino, Marthino Lio, Lutesha, Arie Kriting, dan
              Kristo Immanuel. Film ini tayang secara global di Netflix sejak 15
              Desember 2022.
            </p>
            <br />
            <p className="text-base font-normal text-justify">
              Seorang detektif yang dikenal lurus menyelidiki kematian ayahnya
              dan mengikuti jejak hingga ke sebuah pulau tropis. Di sana, ia
              menemukan jati diri sesungguhnya sang ayah sebagai pemimpin
              kelompok pembunuh bayaran. Kini, ia dikejar musuh ayahnya,
              sehingga ia terpaksa bekerja sama dengan murid ayahnya
              terdahulu—empat mantan pembunuh bayaran yang siap kembali membasmi
              musuh.
            </p>
