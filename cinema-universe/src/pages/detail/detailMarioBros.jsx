...
import banner from "../../assets/img/detailFilm/banner/Mario Bros.jpg";
import { FaRegHeart } from "react-icons/fa6";
import { Link } from "react-router-dom";

function DetailMarioBros({ favoritFilm, setFavoritFilm }) {
  const dataFilm = {
    id: 5,
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row flex-wrap justify-between font-bold text-lg mb-16">
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.bilibili.tv/id/video/4789627585954304"
              allowFullScreen
            ></iframe>
          </div>
        </div>
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row justify-between mb-16">
          <div className="basis-2/5">
            ...
            <p className="text-base font-normal text-justify">
              The Super Mario Bros. Movie adalah film komedi petualangan animasi
              komputer yang diproduksi oleh Illumination bekerja sama dengan
              Nintendo, dan akan didistribusikan oleh Universal Pictures. Ini
              adalah film adaptasi ketiga dari waralaba permainan video Mario
              Nintendo, setelah film anime Super Mario Bros.: The Great Mission
              to Rescue Princess Peach! (1986) dan film aksi langsung Hollywood
              Super Mario Bros (1993). Film ini disutradarai oleh Aaron Horvath
              dan Michael Jelenic dari skenario oleh Matthew Fogel dan
              menampilkan pengisi suara ansambel termasuk Chris Pratt, Anya
              Taylor-Joy, Charlie Day, Jack Black, Keegan-Michael Key, Seth
              Rogen, Fred Armisen, Sebastian Maniscalco, Charles Martinet, dan
              Kevin Michael Richardson.
            </p>
            <br />
            <p className="text-base font-normal text-justify">
              Setelah kegagalan kritis dan komersial film 1993, Nintendo enggan
              melisensikan properti intelektualnya untuk adaptasi film. Pencipta
              Mario, Shigeru Miyamoto, menjadi tertarik untuk mengembangkan film
              lain ketika Nintendo membawa game lamanya ke layanan Konsol
              Virtual, dan melalui kerja sama Nintendo dengan Universal Parks &
              Resorts untuk membuat Super Nintendo World, ia bertemu dengan
              pendiri Illumination, Chris Meledandri. Pada 2016, keduanya
              mendiskusikan film Mario dan pada Januari 2018, Nintendo
              mengumumkan bahwa mereka akan berkolaborasi dengan Illumination
              dan Universal untuk memproduksinya. Produksi sedang berlangsung
              pada tahun 2020. Pada 6 Oktober 2022, cuplikan teaser untuk film
              tersebut ditayangkan melalui Nintendo Direct. The Super Mario
              Bros. Movie dirilis di Amerika Serikat pada 7 April 2023 oleh
              Universal Pictures. Film ini meraih penghasilan kotor sebesar 1,3
              miliar dolar.
            </p>
...
export default DetailMarioBros;
