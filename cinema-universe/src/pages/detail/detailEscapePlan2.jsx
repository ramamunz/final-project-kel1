...
import banner from "../../assets/img/detailFilm/banner/Escape Plan 2.jpg";
import { FaRegHeart } from "react-icons/fa6";
import { Link } from "react-router-dom";

function DetailEscapePlan2({ favoritFilm, setFavoritFilm }) {
  const dataFilm = {
    id: 10,
    title: "Escape Plan 2",
    poster: banner,
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row flex-wrap justify-between font-bold text-lg mb-16">
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/6Q7vVt-MeXk"
            ></iframe>
          </div>
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.bilibili.tv/id/video/2045658187?bstar_from=bstar-web.homepage.recommend.all"
              allowFullScreen
            ></iframe>
          </div>
        </div>
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row justify-between mb-16">
          <div className="basis-2/5">
            ...
            <p className="text-base font-normal text-justify">
              Escape Plan 2: Hades adalah sebuah film laga seru penjara
              penyutradaraan video Amerika Serikat tahun 2018 garapan Steven C.
              Miller. Film tersebut adalah sekuel dari film tahun 2013 Escape
              Plan, dan installment kedua dalam seri film Escape Plan. Film
              tersebut menampilkan Sylvester Stallone dan Curtis "50 Cent"
              Jackson yang mempersembahkan kembali peran-peran mereka dari film
              pertama, dengan Dave Bautista, Huang Xiaoming, Jaime King, Jesse
              Metcalfe, Titus Welliver, dan Wes Chatham ikut membintangi film
              tersebut.
            </p>
