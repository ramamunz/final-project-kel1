...
import banner from "../../assets/img/detailFilm/banner/Lego.jpg";
import { FaRegHeart } from "react-icons/fa6";
import { Link } from "react-router-dom";

function DetailLego({ favoritFilm, setFavoritFilm }) {
  const dataFilm = {
    id: 1,
    title: "The Lego",
    poster: banner,
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row flex-wrap justify-between font-bold text-lg mb-16">
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.bilibili.tv/id/video/2006900550"
              allowFullScreen
            ></iframe>
          </div>
        </div>
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row justify-between mb-16">
          <div className="basis-2/5">
            ...
            <p className="text-base font-normal text-justify">
              The LEGO Movie adalah film animasi komputer tahun 2014 komedi
              petualangan Amerika-Australia yang akan datang disutradarai dan
              ditulis oleh Phil Lord dan Chris Miller, didistribusikan oleh
              Warner Bros Pictures, dan dibintangi oleh Chris Pratt, Will
              Ferrell, Elizabeth Banks, Will Arnett, Nick Offerman, Alison Brie,
              Charlie Day, Liam Neeson, dan Morgan Freeman. Film ini didasarkan
              pada garis mainan Lego konstruksi dan dijadwalkan akan dirilis
              pada tanggal 7 Februari 2014
            </p>
            <br />
            <p className="text-base font-normal text-justify">
              Di alam semesta Lego yang dihuni oleh minifigur antropomorfik,
              penyihir Vitruvius mencoba melindungi senjata super yang disebut
              "Kragle" dari evil Lord Business. Dia gagal untuk melakukannya,
              tetapi bernubuat bahwa seseorang memanggil "the Special" akan
              menemukan Piece of Resistance yang mampu menghentikan Kragle.
              Bisnis kemudian menendang Vitrivius ke danau lava, yang tampaknya
              membunuhnya.
            </p>
