...
import banner from "../../assets/img/detailFilm/banner/Scary Movie 5.jpg";
import { FaRegHeart } from "react-icons/fa6";
import { Link } from "react-router-dom";

function DetailScaryMovie5({ favoritFilm, setFavoritFilm }) {
  const dataFilm = {
    id: 7,
    title: "Scary Movie 5",
    poster: banner,
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row flex-wrap justify-between font-bold text-lg mb-16">
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/RMDZ8M47j0I"
            ></iframe>
          </div>
          ...
          <div>
            ...
            <iframe
              ...
              src="https://www.bilibili.tv/id/video/2047849703"
              allowFullScreen
            ></iframe>
          </div>
        </div>
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row justify-between mb-16">
          <div className="basis-2/5">
            ...
            <p className="text-base font-normal text-justify">
              Scary Movie 5 merupakan sebuah film Amerika Serikat yang dirilis
              pada tahun 2013 Film yang disutradarai oleh Malcolm D. Lee ini
              pemainnya antara lain oleh Ashley Tisdale, Simon Rex, dan masih
              banyak lagi. Tanggal rilisnya pada 12 April 2013.
            </p>
...
export default DetailScaryMovie5;
