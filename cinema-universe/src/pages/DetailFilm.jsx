      ...
      <div className="max-w-auto mx-auto bg-black">
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row flex-wrap justify-between font-bold text-lg mb-16">
          ...
          <div>
            ...
            <iframe
              className="w-[30rem] h-56 rounded-md"
        ...
        <div className="max-w-6xl text-white mx-auto flex flex-row justify-between mb-16">
          <div className="basis-2/5">
            ...
            <p className="text-base font-normal text-justify">
              ...
              (Winston Duke), Okoye (Danai Gurira) and the Dora Milaje
              (including Florence Kasumba), fight to protect their nation from
              intervening world powers in the wake of King T’Challa’s death. As
              the Wakandans strive to embrace their next chapter, the heroes
